...
###final variables -
final variables are nothing but constants. We cannot change the value of a final variable once it is initialized. It is a good practice to name final variable in all CAPS.
